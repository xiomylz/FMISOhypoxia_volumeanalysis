...
for folder_name in os.listdir(os.path.join(current_dir, base_dir)):
    try:
        ...
        file_path_acquisition_1 = os.path.join(folder_path, 'acquisition_1\htv_TMR1.nii')
        if os.path.exists(file_path_acquisition_1):
            ...
            file_path_acquisition_2 = os.path.join(folder_path, 'acquisition_2\htv_TMR1.nii')
            ...
            file_path_acquisition_3 = os.path.join(folder_path, 'acquisition_3\htv_TMR1.nii')
            ...
            results.append(
                {
                    ...
                    "PPV_acquisition_1_vs_acquisition_2":(PPV_coef(imagen_1, imagen_2)) if acquisition_2_exists else 1,
                    "PPV_acquisition_1_vs_acquisition_3":(PPV_coef(imagen_1, imagen_3)) if acquisition_3_exists else 1
                }
            )
        else:
            results.append(
